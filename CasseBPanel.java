...
public class CasseBPanel extends JPanel implements KeyListener{
    ...
    public void setBilleX(int x){billeX = x;}
    public int getBilleX(){return billeX;}
    public void setBilleY(int y){billeY = y;}
    public int getBilleY(){return billeY;}
        ...
        for(int i = 0; i < 11; i++)
            for(int j = 0; j < 5; j++)
                if (this.tabBriques[i][j]!=null)
                    if(!(this.billeX < this.tabBriques[i][j].getX() || this.billeX > this.tabBriques[i][j].getX()+50 || this.billeY < this.tabBriques[i][j].getY() || this.billeY > this.tabBriques[i][j].getY()+12))
                    {
