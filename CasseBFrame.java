...
public class CasseBFrame extends JFrame implements KeyListener{
    ...
    private void updateLabel() {
        this.lab.setText("Score : " + this.gpan.scoreActuel() + " Niveau : " + this.gpan.getNiveau() + " Vies : " + this.gpan.getVies());
    }
    ...
    class EcouteurMenu implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            try{
                ...
                {
                        int niv = Integer.parseInt(JOptionPane.showInputDialog(null, "Entrer le niveau", "Niveau", JOptionPane.QUESTION_MESSAGE));
                        getContentPane().add(gpan, BorderLayout.CENTER);
                        chargerJeu(niv,3);
                        partieLancee = true;
                        gpan.repaint();
